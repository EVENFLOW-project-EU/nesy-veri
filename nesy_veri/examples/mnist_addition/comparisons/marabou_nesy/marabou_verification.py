...
from nesy_veri.examples.mnist_addition.comparisons.marabou_nesy.custom_marabou.custom_read_onnx import (
    custom_read_onnx,
)
...
def create_and_save_onnx(
    ...
    model_path = (
        ...
        / "checkpoints/model_checkpoints/trained_model_2_epochs_softmax.pth"
    )
    mnist_cnn = get_mnist_network(model_path=model_path, num_epochs=2)
...
if __name__ == "__main__":
    ...
    results_path = (
        Path(__file__).parents[2] / "checkpoints/correctly_classified_examples"
    )
